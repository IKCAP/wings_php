/* $Id: canvas.text.js 44 2009-12-29 17:45:19Z fabien.menager $ */
...
(function(){
  ...
  var isOpera9 = window.opera,
		isIphone = (navigator.userAgent.toLowerCase().search('iphone') > -1) ? true: false,
		isIpod = (navigator.userAgent.toLowerCase().search('ipod') > -1) ? true: false,
  ...
  if (!isIphone && !isIpod && proto.strokeText && !ctxt.options.reimplement) {
