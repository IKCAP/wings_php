...
/**
 * The base exception class to notify of errors, while instantiating classes via
 * any of the factories. Each factory, should throw an exception that is a
...
// method A: no need to change interface, obsfuscated use, though
	...
	/**
	 * The name of the class that was trying to be instantiated when this error
	 * occured, or some other signifier like module name.
	 */
	protected String mClassname;

	/**
	 * Converts most of the common instantiation exceptions from the class
	 * loader into an error message. Use for getting sensible error messages, of
	 * the causes that are associated with a FactoryException. The index in the
	 * messages starts from 0.
	 * 
	 ...
	 * Converts most of the common instantiation exceptions from the class
	 * loader into an error message. Use for getting sensible error messages, of
	 * the causes that are associated with a FactoryException.
	 * 
	 * @param classname
	 *            the class that was trying to be loaded or some other
	 *            signifier.
	 * @param e
	 *            the FactoryException that is thrown.
	 * @param index
	 *            the index to start from.
	 * 
	 * @return the error message.
	...
	/**
	 * Constructs a <code>FactoryException</code> with no detail message. The
	 * associated classname is set to value specified by
	 ...
	 * @param classname
	 *            the name of class that was trying to be instantiated or some
	...
	/**
	 * Constructs a <code>FactoryException</code> with the specified detailed
	 * message and a cause. The associated classname is set to value specified
	 * by <code>DEFAULT_NAME</code>.
	 * 
	 * @param msg
	 *            is the detailed message that is to be logged.
	 * @param cause
	 *            is the cause (which is saved for later retrieval by the
	 *            {@link java.lang.Throwable#getCause()} method). A
	 ...
	 *            is the detailed message that is to be logged.
	 * @param classname
	 *            the name of class that was trying to be instantiated.
	 * @param cause
	 *            is the cause (which is saved for later retrieval by the
	 *            {@link java.lang.Throwable#getCause()} method). A
	 *            <code>null</code> value is permitted, and indicates that the
