...
public class DAX {
  ...
  String getDAXHead() {
    ...
    str.append("<adag xsi:schemaLocation=\"http://pegasus.isi.edu/schema/DAX  http://pegasus.isi.edu/schema/dax-2.1.xsd\" \n"
      ...
      + totalnum + "\" index=\"" + index + "\" name=\"" + name + "\">\n");
    return str.toString();
  }
  ...
  String getDAXPart2() {
    ...
    for (Object element : jobList.keySet()) {
      ...
      jobstr = "";
      jobstr += "   <job id=\"" + job.id + "\" namespace=\"" + job.namespace + "\" name=\"" + job.name + "\" version=\"" + job.version + "\">\n";
      ...
      for (Binding binding : job.inputFiles) {
        ...
        while (!cbs.isEmpty()) {
          ...
          if (b.isSet()) {
            ...
            jobstr += "      <uses file=\"" + b.getName() + "\" link=\"input\" register=\"true\"/>\n";
          }
        }
      }
      ...
      for (Binding binding : job.outputFiles) {
        ...
        while (!cbs.isEmpty()) {
          ...
          if (b.isSet()) {
            ...
            jobstr += "      <uses file=\"" + b.getName() + "\" link=\"output\" register=\"true\"/>\n";
          }
        }
      }
  ...
  private String createDotNode(String id, String label, String shape, String color) {
    ...
    return "\t" + getDotId(id) + "[label=\"" + label + "\" shape=\"" + shape + "\" height=\"0.25\" style=\"filled\" fillcolor=\"" + color + "\"];\n";
  }
        ...
        for (Binding binding : job.inputFiles) {
          ...
          while (!cbs.isEmpty()) {
            ...
            if (b.isSet()) {
              ...
              sb.append(createDotNode(b.getName(), b.getName().length() < 32 ? b.getName() : "", "box", "cyan"));
  ...
  public void importDAX(DAX dax) {
    // import the job list
    for (Iterator i = dax.jobList.keySet().iterator(); i.hasNext();) {
